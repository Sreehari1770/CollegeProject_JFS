...
function Services() {
    return (<>
        <h2 id='service'>Discover our services</h2>
        <div class="row1">
            <div class="column1">
            ...
            <div class="column1">
                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-screwdriver" viewBox="0 0 16 16">
