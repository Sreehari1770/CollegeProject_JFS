  ...
  <div class="container-fluid">
    ...
    <div class="centered">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputFname" aria-describedby="FnameHelp" placeholder="Enter your First Name" onChange={(e) => setFirstName(e.target.value)}></input>
            {/* <small id="FnameHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> */}
        </div>
        <div class="form-group">
            <label for="exampleInputLname">Last Name</label>
            <input type="text" class="form-control" id="exampleInputLname" aria-describedby="LnameHelp" placeholder="Enter Your Last Name" onChange={(e) => setLastName(e.target.value)}></input>
