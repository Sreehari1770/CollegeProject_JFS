        ...
        <div class="column1" >
          <Card sx={{ maxWidth: 345 }}>
            ...
            <CardActions>
              ...
              <Button id='cartbtn' size="small" component={Link} to="/sofa" >view more</Button>
            </CardActions>
          </Card>
        </div>
        <div class="column1" >
          <Card sx={{ maxWidth: 345 }}>
            ...
            <CardActions>
              {/* <Button size="small">Buy</Button> */}
              <Button size="small" component={Link} to="/beds" >view more</Button>
            </CardActions>
          </Card>
        </div>
        <div class="column1" >
          <Card sx={{ maxWidth: 345 }}>
            ...
            <CardActions>
              {/* <Button size="small">Buy</Button> */}
              <Button size="small" component={Link} to="/chairs">view more</Button>
            </CardActions>
          </Card>
        </div>
      </div>
      ...
      <div class="row1">
        <div class="column1" >
          <Card sx={{ maxWidth: 345 }}>
            ...
            <CardActions>
              {/* <Button size="small">Buy</Button> */}
              <Button size="small" component={Link} to="/shelves">view more</Button>
            </CardActions>
          </Card>
        </div>
        <div class="column1" >
          <Card sx={{ maxWidth: 345 }}>
            ...
            <CardActions>
              {/* <Button size="small">Buy</Button> */}
              <Button size="small" component={Link} to="/tables">view more</Button>
            </CardActions>
          </Card>
        </div>
        <div class="column1" >
